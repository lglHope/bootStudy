...
public class InfixToSuffix {
    ...
    //当前字符是 ')'时，如果栈顶是'(',则将这一对括号丢弃，否则依次弹出s1栈顶的字符，压入s2，直到遇 到'('
    ...
    public static void main(String[] args) {
        InfixToSuffix infixToSuffix = new InfixToSuffix("3+4-5+6");
        infixToSuffix.doTrans().displayStack();
//        MyCharStack myCharStack = new MyCharStack(5);
//        myCharStack.push('1');
//        myCharStack.push('2');
//        myCharStack.push('3');
//        myCharStack.push('4');
